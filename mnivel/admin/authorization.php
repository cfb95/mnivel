...
function SetUpUserAuthorization()
{
    ...
    $userAuthorizationStrategy = new ServerSideUserAuthorization($fixedRoles, 'guest', false, '', '');
...
{
    return new ServerSideIdentityCheckStrategy(new PgConnectionFactory(), GetGlobalConnectionOptions());
}
